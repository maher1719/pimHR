...
import {ListFavoriteUser} from "../../../api/profileApi";
import {useSelector} from "react-redux";

const ProfileFavoris = () => {
    ...
    useEffect(() => {
        ListFavoriteUser({"_id": id}).then((data) => {
                ...
                <section className="content">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h3 className="card-title">Mes utilisateurs avoris</h3>
